...
import { addDoctor,adminDashboard,allAppointments,allDoctors,cancellappointment,deleteAppointment,loginAdmin} from "../controllers/admin.controller.js"
...
adminRouter.get('/dashboard',varifyAdmin,adminDashboard)
